...
A car showcase application using Next.js 14.
...
Create a Next.js 14 project using,
...
I'm using the [headlessui](https://headlessui.com/) to create combobox and dropdowns. To download the package, 
```bash
...
In this application, we could have easily fetched the data on the client side using states and useEffect. However, I have chosen to implement server-side rendering instead. So, how do we go about it?
